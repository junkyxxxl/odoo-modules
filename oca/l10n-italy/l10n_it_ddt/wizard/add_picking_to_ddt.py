...
class AddPickingToDdt(models.TransientModel):
    ...
    def add_to_ddt(self):
        ...
        for picking in pickings:
            ...
            if picking.parcels:
                self.env['stock.ddt'].write(self.ddt_id.id,{'parcels':self.ddt_id.parcels+picking.number_of_packages})                    
            elif picking.sale_id and picking.sale_id.parcels:
                self.ddt_id.write({'parcels':self.ddt_id.parcels+picking.sale_id.parcels})
