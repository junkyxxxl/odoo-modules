...
class ResCompany(models.Model):
    ...
    _sql_constraints = [
        ('amount_interest_percent1', 'CHECK (of_account_end_vat_statement_interest_percent>=0)', 'Amount interest must >= 0!'),
        ('amount_interest_percent2', 'CHECK (of_account_end_vat_statement_interest_percent<=100)', 'Amount interest must be <= 100!'),
    ]
