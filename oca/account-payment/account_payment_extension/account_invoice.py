...
class account_invoice(orm.Model):
    ...
    def onchange_partner_id(self, type, partner_id, date_invoice=False,
        ...
        payment_type = False
        if partner_id:
            partner = self.pool.get('res.partner').browse(self._cr, self._uid, partner_id)
        ...
        return self._model.onchange_payment_type(
            self._cr, self._uid, self._ids, payment_type, partner_id, result)
