...
class AccountReportOpenInvoicesWizard(orm.TransientModel):
    ...
    _columns = {
        ...
        'maturity_date': fields.date("Data di Scadenza:", help="Se impostato, saranno stampate solo quelle righe con data di scadenza precedente alla data selezionata."),
...
""")}
    ...
    def pre_print_report(self, cr, uid, ids, data, context=None):
        ...
        vals = self.read(cr, uid, ids,
                         ['until_date', 'group_by_currency','maturity_date'],
                         context=context)[0]
