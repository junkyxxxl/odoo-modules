...
Summary: Modules for Odoo for Asl-VT.
Group: System Environment/Daemons
%description
Modules for Odoo for Asl-VT.

%package custom-asl-vt
Summary: Modules for Odoo for customer Asl-VT
%description custom-asl-vt
Modules for Odoo for customer Asl-VT
...
cp -r customers/asl-vt/* %{buildroot}%{python_sitelib}/openerp/addons/isa
