...
Summary: Modules for Odoo for B2pharma.
Group: System Environment/Daemons
%description
Modules for Odoo for B2pharma.

%package custom-b2pharma
Summary: Modules for Odoo for customer B2pharma Srl.
%description custom-b2pharma
Modules for Odoo for customer B2pharma Srl.
...
#Website Theme
cp -r themes/* %{buildroot}%{python_sitelib}/openerp/addons/isa
