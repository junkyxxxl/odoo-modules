...
class wizard_customer_payment(orm.TransientModel):
    _name = 'wizard.customer.payment'
    _description = 'Wizard Customer Payment Makeover'
    ...
    def view_report(self, cr, uid, ids, context=None):
        ...
        if(form["partner_id"]):
            ...
            t_allcustomers = False
        t_maturity = form["maturity"]
        t_it = form["it_customer"]
        t_ext = form["ext_customer"]
        t_riba = form["riba"]
        if(form["bank_id"]):
        ...
        context.update({
            ...
            'default_it_customer': t_it,
            'default_ext_customer': t_ext,
            ...
            'default_all_customer': t_allcustomers,
            'default_riba': t_riba,
        })
        ...
        return {
              'name': _("Customer Payment Specification"),
              'view_type': 'form',
              'view_mode': 'form',
