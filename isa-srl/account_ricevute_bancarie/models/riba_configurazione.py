...
class RibaConfigurazione(models.Model):
    ...
    unsolved_bank_account_id = fields.Many2one('account.account', "Bank account", domain=[('type','=','liquidity')])
    ...
    def get_default_value_by_distinta_line(self, cr, uid, field_name, context=None):
        ...
        res = distinta_line.distinta_id.config[field_name] and distinta_line.distinta_id.config[field_name].id or False
        return res
