...
class sale_report(report_sxw.rml_parse):
      ...
      def _get_order_line(self, order_id, limit_page, offset_page):
        ...
        if order_data and order_data.order_line:
            hrs_list = []
            hrs = self.pool.get('sale.order.line')
...
class report_saleorder_makeover(osv.AbstractModel):
    _name = 'report.sale_order_report_qweb.report_saleorder_makeover'
    _inherit = 'report.abstract_report'
    _template = 'sale_order_report_qweb.report_saleorder_makeover'
