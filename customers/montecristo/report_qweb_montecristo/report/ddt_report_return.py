...
class report_ddt_return_parser(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context=None):
        ...
        if context is None:
            context = {}
        super(report_ddt_return_parser,
...
class report_ddt_return(osv.AbstractModel):
    _name = 'report.report_qweb_montecristo.report_ddt_return'
    _inherit = 'report.abstract_report'
    _template = 'report_qweb_montecristo.report_ddt_return'
    _wrapped_report_class = report_ddt_return_parser
