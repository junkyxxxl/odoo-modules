...
class report_ddt_parser(report_sxw.rml_parse):
...
class report_product_barcode(osv.AbstractModel):
    _name = 'report.report_qweb_montecristo.report_ddt'
    _inherit = 'report.abstract_report'
    _template = 'report_qweb_montecristo.report_ddt'
    _wrapped_report_class = report_ddt_parser
