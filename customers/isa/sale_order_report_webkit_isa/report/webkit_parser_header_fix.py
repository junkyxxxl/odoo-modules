...
class HeaderFooterTextWebKitParser(webkit_report.WebKitParser):
    ...
    def generate_pdf(self, comm_path, report_xml, header, footer, html_list, webkit_header=False, parser_instance=None):
        ...
        if parser_instance and parser_instance.localcontext.get('additional_args', False):
    ...
    def create_single_pdf(self, cursor, uid, ids, data, report_xml, context=None):
        ...
        pdf = self.generate_pdf(bin, report_xml, head, foot, htmls, parser_instance=parser_instance)
        return (pdf, 'pdf')
