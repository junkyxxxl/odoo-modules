...
class report_saleorder_isa(osv.AbstractModel):
    _name = 'report.sale_order_report_qweb_isa.report_saleorder_isa'
    _inherit = 'report.abstract_report'
    _template = 'sale_order_report_qweb_isa.report_saleorder_isa'
