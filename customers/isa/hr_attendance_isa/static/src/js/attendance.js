    ...
    instance.hr_attendance.AttendanceSlider = instance.web.Widget.extend({
        ...
        do_popup_attendance: function () {
            ...
            hr_employee.call('attendance_action_change', [
                ...
                hr_employee.call('attendance_action_exit', [
                    [self.employee.id]
                ]).done(function (result) {

                    var action = {
                            type: 'ir.actions.act_window',
                            res_model: 'wizard.select.sign.out',
                            view_mode: 'form',
                            view_type: 'form',
                            views: [[false, 'form']],
                            target: 'new',
                            context: {'view_exit': 1, 'default_attendance_id': result,}
                    };
