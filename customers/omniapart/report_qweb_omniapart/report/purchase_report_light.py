...
class purchase_report_light(report_sxw.rml_parse):
    
      def __init__(self, cr, uid, name, context=None):
        super(purchase_report_light, self).__init__(cr, uid, name, context=context)
...
class report_purchaseorder_makeover(osv.AbstractModel):
    _name = 'report.report_qweb_omniapart.report_purchaseorder_light'
    _inherit = 'report.abstract_report'
    _template = 'report_qweb_omniapart.report_purchaseorder_light'
    _wrapped_report_class = purchase_report_light
