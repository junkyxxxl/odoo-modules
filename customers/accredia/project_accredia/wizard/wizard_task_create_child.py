...
class wizard_task_create_child(orm.TransientModel):
    _name = 'wizard.task.create.child'
    _description = 'Wizard Crea Attivita Delegata'
    ...
    def do_create(self, cr, uid, ids, context=None):
        ...
        if ids:
            task_obj.write(cr, uid, [t_parent_id], {'child_ids': [(4, t_task_id)]})
