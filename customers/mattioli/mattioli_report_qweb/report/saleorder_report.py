...
class saleorder_report_parser(report_sxw.rml_parse):
    ...
    def _get_records(self, doc):
        res = []
        inv_data = doc
        for line in inv_data.order_line:
            ...
            if line.product_id:
                ...
                if line.product_id.thickness == line.thickness:                           
                    ...
                    temp_thickness = line.thickness * line.product_uom_qty
                else:
                    temp_thickness = 0.0    
                ...
                if line.width == 1 and line.length == 1:
                    ...
                    temp_width = line.width * line.product_uom_qty
                else:
                    temp_width = 0.0                         
                ...
                if line.width == 1 and line.length == 1:
                    ...
                    temp_length = line.length * line.product_uom_qty
                else:
                    temp_length = 0.0                         
            ...
            if line.product_uos and (line.product_uos.is_cubic_meter or line.product_uos.is_square_meter):
                tmp.append(line.price_uos)
            else:
...
class report_invoice(osv.AbstractModel):
    _name = 'report.mattioli_report_qweb.mattioli_report_saleorder'
    _inherit = 'report.abstract_report'
    _template = 'mattioli_report_qweb.mattioli_report_saleorder'
    _wrapped_report_class = saleorder_report_parser
