...
from openerp import netsvc, report, api
...
class mail_compose_message(osv.TransientModel):
    ...
    def generate_email_for_composer(self, cr, uid, template_id, res_id, context=None):
        ...
        fields = ['body_html', 'subject', 'email_to', 'partner_to', 'email_cc','email_bcc', 'attachment_ids', 'attachments']
...
class mail_notification(osv.Model):
    ...
    def _notify(self, cr, uid, msg_id, partners_to_notify=None, context=None,
        ...
        notify_partner_ids = partners_to_notify
        #notify_partner_ids = self.get_partners_to_email(cr, uid, partners_to_notify, msg, context=context)
...
class mail_thread(osv.AbstractModel):
    ...
    def message_post(self, cr, uid, thread_id, body='', subject=None, type='notification',
        ...
        for email_cc_id in kwargs_email_cc_ids:
            if isinstance(partner_ids, (list, tuple)) and email_cc_id[0] == 4 and len(email_cc_id) == 2:
        ...
        for email_bcc_id in kwargs_email_bcc_ids:
            if isinstance(partner_ids, (list, tuple)) and email_bcc_id[0] == 4 and len(email_bcc_id) == 2:
...
class email_template(osv.osv):
    ...
    def generate_email(self, cr, uid, template_id, res_id, context=None):
        ...
        if template.report_template:
            ...
            (result, format) = report.render_report(cr, uid, [res_id], report_service, {'model': template.model}, ctx)
