    ...
    def test_connection(self, cr, uid, ids, context={}):
        for config in self.browse(cr, uid, ids, context=context):
            try:
                ...
                raise orm.except_orm(('Error !'), ("Can't establish connection to %s! Please, check settings." % config.host))
            raise orm.except_orm(('Success!'), ("Connection to %s established!" % config.host))
