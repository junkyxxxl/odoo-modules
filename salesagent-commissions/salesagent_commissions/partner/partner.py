...
class res_partner(orm.Model):
    ...
    def fill_products(self, cr, uid, ids, context=None):
        ...
        for t_id in ids:
            for product in products:
                self.pool.get('partner.product_commission').create(cr, uid, {'partner_id':t_id,'name':product.id})
        return True
    ...
    _columns = {
        ...
        'product_category_provvigioni_ids' : fields.one2many('partner.product_category_commission', 'partner_id', 'Commission for product categories'),
    }
